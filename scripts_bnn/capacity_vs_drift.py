...
def n_params(width_log2, depth, d_in=OBS_DIM):
    ...
    # log2 exponent above 10, and the 2026-09-15 ranges expand to widths as
    # small as 16 (handoff 3.2.16), so >10 can only be an already-expanded width.
    W = float(width_log2) if width_log2 > 10 else 2.0 ** int(width_log2)
    d = int(depth)
