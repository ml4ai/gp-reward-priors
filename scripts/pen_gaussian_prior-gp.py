...
wdist_fig = os.path.join(FIG_DIR, "pen_gp_wsr_plot.png")
...
plt.tight_layout()
prior_fig = os.path.join(FIG_DIR, "pen_gp_priors_plot.png")
...
plt.tight_layout()
post_fig = os.path.join(FIG_DIR, "pen_gp_posteriors_plot.png")
