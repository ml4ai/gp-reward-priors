...
class TrainConfig:
    ...
    print_every: int = 20
    seed: int = 1
    OUT_DIR: Optional[str] = "./exp/reward_learning/pen_tuning"  # Save path
...
def train(config: TrainConfig):
    ...
    plt.ylabel(r"$W_1(p_{r}, p_{nn})$")
    plt.xlabel("Iteration")
    wdist_fig = os.path.join(config.FIG_DIR, "pen_gp_wsr_plot.png")
    ...
    plt.tight_layout()
    prior_fig = os.path.join(config.FIG_DIR, "pen_gp_priors_plot.png")
