...
wdist_fig = os.path.join(FIG_DIR, "pen_wsr_plot.png")
...
plt.tight_layout()
prior_fig = os.path.join(FIG_DIR, "pen_priors_plot.png")
...
plt.tight_layout()
post_fig = os.path.join(FIG_DIR, "pen_posteriors_plot.png")
